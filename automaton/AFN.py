...
from automaton.configuration import (alternative, dot, epsilon, question, star,
                                     symbols)
...
class AFN:
    ...
    def graph_AFN(self):
        ...
        with open('results/AFN.dot', 'w', encoding='utf-8') as file:
            keys = list(self.transitions)
            file.write('digraph{\n')
        ...
        (graph,) = pydot.graph_from_dot_file('results/AFN.dot')
        graph.write_png('results/AFN.png')
